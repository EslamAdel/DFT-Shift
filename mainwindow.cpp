...
void MainWindow::on_pushButton_clicked()
{
    ...
    ui->label_5->setText(tr("Shift Value in X : %1\nShift Value in Y :%2\n ")
                         .arg(XshiftValue).arg(YshiftValue));
...
void MainWindow::on_horizontalSlider_sliderReleased()
{
    ...
    XshiftValue=mainCode(500,500,ui->horizontalSlider->sliderPosition(),0);
...
void MainWindow::on_horizontalSlider_2_sliderReleased()
{
    ...
    YshiftValue=mainCode(500,500,0,ui->horizontalSlider_2->sliderPosition());
